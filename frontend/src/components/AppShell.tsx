...
import { ArrowRightLeft, BarChart3, Boxes, ChevronDown, CircleHelp, ClipboardList, LayoutDashboard, LineChart, LogOut, Menu, Package, Settings, ShoppingCart, Truck, Users, Warehouse, Target } from "lucide-react";
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  const intelligenceItems = [
    [BarChart3, t("intelligence"), "/intelligence"], [LineChart, t("forecasting"), "/forecasting"], [Target, "Analytics", "/analytics"], [Target, "Supply Quests", "/quests"], [ShieldIcon, t("recommendations"), "/intelligence/recommendations"], [AlertIcon, t("alerts"), "/intelligence/alerts"],
  ] as const;
